...
@useResult
$Res call({
@JsonKey(name: 'session_id') String id,@JsonKey(name: 'user_id') String? userId,@JsonKey(name: 'drug_id') String? drugId,@JsonKey(name: 'drug') Drug? drug,@JsonKey(name: 'rate') double infusionRate,@JsonKey(name: 'total_volume') double totalVolume,@JsonKey(name: 'volume_infused') double volumeInfused,@JsonKey(name: 'status') String status,@JsonKey(name: 'start_time') DateTime? startTime,@JsonKey(name: 'end_time') DateTime? endTime,@JsonKey(name: 'bolus_enabled') bool bolusEnabled,@JsonKey(name: 'kvo_enabled') bool kvoEnabled,@JsonKey(name: 'kvo_rate') double? kvoRate,@JsonKey(name: 'patient_weight') double patientWeight,@JsonKey(name: 'target_dose') double? targetDose,@JsonKey(name: 'dose_unit') String doseUnit,@JsonKey(name: 'battery_level') int? batteryLevel,@JsonKey(name: 'clinician') Map<String, dynamic>? clinicianData
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'session_id')  String id, @JsonKey(name: 'user_id')  String? userId, @JsonKey(name: 'drug_id')  String? drugId, @JsonKey(name: 'drug')  Drug? drug, @JsonKey(name: 'rate')  double infusionRate, @JsonKey(name: 'total_volume')  double totalVolume, @JsonKey(name: 'volume_infused')  double volumeInfused, @JsonKey(name: 'status')  String status, @JsonKey(name: 'start_time')  DateTime? startTime, @JsonKey(name: 'end_time')  DateTime? endTime, @JsonKey(name: 'bolus_enabled')  bool bolusEnabled, @JsonKey(name: 'kvo_enabled')  bool kvoEnabled, @JsonKey(name: 'kvo_rate')  double? kvoRate, @JsonKey(name: 'patient_weight')  double patientWeight, @JsonKey(name: 'target_dose')  double? targetDose, @JsonKey(name: 'dose_unit')  String doseUnit, @JsonKey(name: 'battery_level')  int? batteryLevel, @JsonKey(name: 'clinician')  Map<String, dynamic>? clinicianData)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InfusionSession() when $default != null:
return $default(_that.id,_that.userId,_that.drugId,_that.drug,_that.infusionRate,_that.totalVolume,_that.volumeInfused,_that.status,_that.startTime,_that.endTime,_that.bolusEnabled,_that.kvoEnabled,_that.kvoRate,_that.patientWeight,_that.targetDose,_that.doseUnit,_that.batteryLevel,_that.clinicianData);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'session_id')  String id, @JsonKey(name: 'user_id')  String? userId, @JsonKey(name: 'drug_id')  String? drugId, @JsonKey(name: 'drug')  Drug? drug, @JsonKey(name: 'rate')  double infusionRate, @JsonKey(name: 'total_volume')  double totalVolume, @JsonKey(name: 'volume_infused')  double volumeInfused, @JsonKey(name: 'status')  String status, @JsonKey(name: 'start_time')  DateTime? startTime, @JsonKey(name: 'end_time')  DateTime? endTime, @JsonKey(name: 'bolus_enabled')  bool bolusEnabled, @JsonKey(name: 'kvo_enabled')  bool kvoEnabled, @JsonKey(name: 'kvo_rate')  double? kvoRate, @JsonKey(name: 'patient_weight')  double patientWeight, @JsonKey(name: 'target_dose')  double? targetDose, @JsonKey(name: 'dose_unit')  String doseUnit, @JsonKey(name: 'battery_level')  int? batteryLevel, @JsonKey(name: 'clinician')  Map<String, dynamic>? clinicianData)  $default,) {final _that = this;
switch (_that) {
case _InfusionSession():
return $default(_that.id,_that.userId,_that.drugId,_that.drug,_that.infusionRate,_that.totalVolume,_that.volumeInfused,_that.status,_that.startTime,_that.endTime,_that.bolusEnabled,_that.kvoEnabled,_that.kvoRate,_that.patientWeight,_that.targetDose,_that.doseUnit,_that.batteryLevel,_that.clinicianData);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'session_id')  String id, @JsonKey(name: 'user_id')  String? userId, @JsonKey(name: 'drug_id')  String? drugId, @JsonKey(name: 'drug')  Drug? drug, @JsonKey(name: 'rate')  double infusionRate, @JsonKey(name: 'total_volume')  double totalVolume, @JsonKey(name: 'volume_infused')  double volumeInfused, @JsonKey(name: 'status')  String status, @JsonKey(name: 'start_time')  DateTime? startTime, @JsonKey(name: 'end_time')  DateTime? endTime, @JsonKey(name: 'bolus_enabled')  bool bolusEnabled, @JsonKey(name: 'kvo_enabled')  bool kvoEnabled, @JsonKey(name: 'kvo_rate')  double? kvoRate, @JsonKey(name: 'patient_weight')  double patientWeight, @JsonKey(name: 'target_dose')  double? targetDose, @JsonKey(name: 'dose_unit')  String doseUnit, @JsonKey(name: 'battery_level')  int? batteryLevel, @JsonKey(name: 'clinician')  Map<String, dynamic>? clinicianData)?  $default,) {final _that = this;
switch (_that) {
case _InfusionSession() when $default != null:
return $default(_that.id,_that.userId,_that.drugId,_that.drug,_that.infusionRate,_that.totalVolume,_that.volumeInfused,_that.status,_that.startTime,_that.endTime,_that.bolusEnabled,_that.kvoEnabled,_that.kvoRate,_that.patientWeight,_that.targetDose,_that.doseUnit,_that.batteryLevel,_that.clinicianData);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,drugId,drug,infusionRate,totalVolume,volumeInfused,status,startTime,endTime,bolusEnabled,kvoEnabled,kvoRate,patientWeight,targetDose,doseUnit,batteryLevel,const DeepCollectionEquality().hash(_clinicianData));
...
/// Create a copy of InfusionSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = freezed,Object? drugId = freezed,Object? drug = freezed,Object? infusionRate = null,Object? totalVolume = null,Object? volumeInfused = null,Object? status = null,Object? startTime = freezed,Object? endTime = freezed,Object? bolusEnabled = null,Object? kvoEnabled = null,Object? kvoRate = freezed,Object? patientWeight = null,Object? targetDose = freezed,Object? doseUnit = null,Object? batteryLevel = freezed,Object? clinicianData = freezed,}) {
