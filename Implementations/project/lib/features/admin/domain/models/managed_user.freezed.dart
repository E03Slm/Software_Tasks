...
@JsonKey(name: 'user_id') String get id;@JsonKey(name: 'national_id') String? get nationalId;@JsonKey(name: 'Fname') String? get fname;@JsonKey(name: 'Mname') String? get mname;@JsonKey(name: 'Lname') String? get lname;@JsonKey(name: 'role', fromJson: _roleFromJson, toJson: _roleToJson) RoleType get role;@JsonKey(name: 'Is_Deleted') bool get isDeleted;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nationalId,fname,mname,lname,role,isDeleted,createdAt,updatedAt);

@override
String toString() {
  return 'ManagedUser(id: $id, nationalId: $nationalId, fname: $fname, mname: $mname, lname: $lname, role: $role, isDeleted: $isDeleted, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
@JsonKey(name: 'user_id') String id,@JsonKey(name: 'national_id') String? nationalId,@JsonKey(name: 'Fname') String? fname,@JsonKey(name: 'Mname') String? mname,@JsonKey(name: 'Lname') String? lname,@JsonKey(name: 'role', fromJson: _roleFromJson, toJson: _roleToJson) RoleType role,@JsonKey(name: 'Is_Deleted') bool isDeleted,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of ManagedUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nationalId = freezed,Object? fname = freezed,Object? mname = freezed,Object? lname = freezed,Object? role = null,Object? isDeleted = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
switch (_that) {
case _ManagedUser() when $default != null:
return $default(_that.id,_that.nationalId,_that.fname,_that.mname,_that.lname,_that.role,_that.isDeleted,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _ManagedUser extends ManagedUser {
  const _ManagedUser({@JsonKey(name: 'user_id') required this.id, @JsonKey(name: 'national_id') this.nationalId, @JsonKey(name: 'Fname') this.fname, @JsonKey(name: 'Mname') this.mname, @JsonKey(name: 'Lname') this.lname, @JsonKey(name: 'role', fromJson: _roleFromJson, toJson: _roleToJson) required this.role, @JsonKey(name: 'Is_Deleted') this.isDeleted = false, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt}): super._();
...
/// Create a copy of ManagedUser
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? nationalId = freezed,Object? fname = freezed,Object? mname = freezed,Object? lname = freezed,Object? role = null,Object? isDeleted = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
