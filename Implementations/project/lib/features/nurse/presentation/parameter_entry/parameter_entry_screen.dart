            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _buildVerticalDivider(),
                  _buildInfoColumn('HARD LIMITS', drug != null ? '${drug.hardLimitLow} - ${drug.hardLimitHigh} ${drug.rateUnit}' : '---', valueColor: Colors.red.shade700),
                  _buildVerticalDivider(),
                  _buildInfoColumn('SOFT LIMITS', drug != null ? (drug.softLimitHigh != null ? '${drug.softLimitLow ?? 0} - ${drug.softLimitHigh} ${drug.rateUnit}' : 'None') : '---', valueColor: Colors.orange.shade700),
                  _buildVerticalDivider(),
          ...
          children: [
            Expanded(
              child: _buildParameterCard(
                ...
                highlight: true,
                subtitle: drug != null ? 'Hard Limits: ${drug.hardLimitLow} - ${drug.hardLimitHigh} ${drug.rateUnit}' : null,
                drug: drug,
              ),
            ),
