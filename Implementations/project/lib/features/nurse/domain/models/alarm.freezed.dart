...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'alarm_id')  String id, @JsonKey(name: 'session_id')  String sessionId,  String? definitionId,  String type,  String severity,  DateTime timestamp,  bool acknowledged, @JsonKey(name: 'acknowledged_by')  String? acknowledgedBy, @JsonKey(name: 'acknowledged_at')  DateTime? acknowledgedAt,  bool resolved, @JsonKey(name: 'resolved_at')  DateTime? resolvedAt,  String? description)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Alarm() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'alarm_id')  String id, @JsonKey(name: 'session_id')  String sessionId,  String? definitionId,  String type,  String severity,  DateTime timestamp,  bool acknowledged, @JsonKey(name: 'acknowledged_by')  String? acknowledgedBy, @JsonKey(name: 'acknowledged_at')  DateTime? acknowledgedAt,  bool resolved, @JsonKey(name: 'resolved_at')  DateTime? resolvedAt,  String? description)  $default,) {final _that = this;
switch (_that) {
case _Alarm():
return $default(_that.id,_that.sessionId,_that.definitionId,_that.type,_that.severity,_that.timestamp,_that.acknowledged,_that.acknowledgedBy,_that.acknowledgedAt,_that.resolved,_that.resolvedAt,_that.description);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'alarm_id')  String id, @JsonKey(name: 'session_id')  String sessionId,  String? definitionId,  String type,  String severity,  DateTime timestamp,  bool acknowledged, @JsonKey(name: 'acknowledged_by')  String? acknowledgedBy, @JsonKey(name: 'acknowledged_at')  DateTime? acknowledgedAt,  bool resolved, @JsonKey(name: 'resolved_at')  DateTime? resolvedAt,  String? description)?  $default,) {final _that = this;
switch (_that) {
case _Alarm() when $default != null:
return $default(_that.id,_that.sessionId,_that.definitionId,_that.type,_that.severity,_that.timestamp,_that.acknowledged,_that.acknowledgedBy,_that.acknowledgedAt,_that.resolved,_that.resolvedAt,_that.description);case _:
  return null;
